...
@interface TXImageCropController ()

@end

@implementation TXImageCropController
...
- (void)drawImageWithContent {
    ...
    // 绘图和图像倒立的问题了
    layer.contents = (__bridge id _Nullable)([UIImage imageNamed:@"IMG_0346.PNG"].CGImage);
...
- (void)drawLayer:(CALayer *)layer inContext:(CGContextRef)ctx {
    ...
    UIImage *image = [UIImage imageNamed:@"IMG_0346.PNG"];
